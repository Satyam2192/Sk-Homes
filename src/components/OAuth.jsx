...
export default function OAuth() {
  ...
  const handleGoogleClick = async () => {
    try {
      ...
      const res = await fetch(`https://sk-home-backend.onrender.com/api/auth/google`, {
        method: 'POST',
        headers: {
  ...
  return (
    <button onClick={handleGoogleClick} type="button" className="w-full block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300">
