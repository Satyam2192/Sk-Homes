...
const Loader = () => {
  ...
  return (
    <div className='flex justify-center items-center h-[100vh]'>< svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-live="polite" aria-busy="true" aria-labelledby="title-08a desc-08a" className="w-12 h-12">
